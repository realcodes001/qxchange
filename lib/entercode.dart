...
class _EntryPageState extends State<EntryPage> {
  ...
  Future<String?> _getSavedPasscode() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString('saved_passcode');
  }
  ...
  void addToPasscode(String digit) {
    ...
    // Check if the entered passcode matches the saved passcode if 4 digits are entered
    if (enteredPasscode.length == 4) {
      _getSavedPasscode().then((savedPasscode) {
        if (enteredPasscode == savedPasscode) {
          // Passcodes match, navigate to the main app

          // Navigate to the main app or home page
